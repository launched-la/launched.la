...
export default ({ data }) => (
  <Page>
    ...
    <div>
      ...
      <p style={{ marginTop: '2rem', maxWidth: '700px' }}>
        We conceive, explore, and launch healthy lifestyle next-gen brands offering premium but affordable choices in retail and beyond. We
        work with other passionate thought leaders to deliver on the promise that everyone deserves access to healthier alternatives.
      </p>
      <div className='grid'>
      ...
      <p>
        <b>
          Interested in joining our team? Check out our <a href='https://boards.greenhouse.io/launchedla'>Careers</a> page.
        </b>
      </p>
      <p>
        For all inquiries please <a href='mailto:contact@launched.la'>contact us</a>.
      </p>
